...
namespace Rotorz.ReorderableList {
	...
	public class GenericListAdapter<T> : IReorderableListAdapter {
		...
		/// <summary>
		/// Initializes a new instance of <see cref="GenericListAdapter{T}"/>.
		/// </summary>
		...
		public GenericListAdapter(IList<T> list, ReorderableListControl.ItemDrawer<T> itemDrawer, float itemHeight) {
			this._list = list;
