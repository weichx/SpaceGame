...
namespace Rotorz.ReorderableList {
	...
	/// <summary>
	/// Can be implemented along with <see cref="IReorderableListAdapter"/> when drop
	...
	/// <see cref="IReorderableListAdapter"/> could insert entirely new items by
	/// dragging and dropping from the Unity "Project" window.</para>
	/// </remarks>
	/// <see cref="IReorderableListAdapter"/>
