...
namespace Rotorz.ReorderableList {
	...
	public static class ReorderableListGUI {
		...
		private static void DoListField<T>(IList<T> list, ReorderableListControl.ItemDrawer<T> drawItem, ReorderableListControl.DrawEmpty drawEmpty, float itemHeight, ReorderableListFlags flags) {
			var adaptor = new GenericListAdapter<T>(list, drawItem, itemHeight);
		...
		public static float CalculateListFieldHeight(SerializedProperty arrayProperty, ReorderableListFlags flags) {
			...
			try {
				DefaultListControl.Flags = flags;
				return DefaultListControl.CalculateListHeight(new SerializedPropertyAdapter(arrayProperty));
			}
			finally {
				DefaultListControl.Flags = restoreFlags;
			}
		...
		public static void ListFieldAbsolute(Rect position, IReorderableListAdapter adapter, ReorderableListControl.DrawEmptyAbsolute drawEmpty, ReorderableListFlags flags) {
			DoListFieldAbsolute(position, adapter, drawEmpty, flags);
		}
		...
		/// <inheritdoc cref="DoListFieldAbsolute(Rect, IReorderableListAdapter, ReorderableListControl.DrawEmptyAbsolute, ReorderableListFlags)"/>
		public static void ListFieldAbsolute(Rect position, IReorderableListAdapter adapter, ReorderableListFlags flags) {
			DoListFieldAbsolute(position, adapter, null, flags);
		}
