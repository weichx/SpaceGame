...
namespace Rotorz.ReorderableList {
	...
	/// </remarks>
	public class SerializedPropertyAdapter : IReorderableListAdapter {
		...
		/// <summary>
		/// Initializes a new instance of <see cref="SerializedPropertyAdapter"/>.
		/// </summary>
		...
		public SerializedPropertyAdapter(SerializedProperty arrayProperty, float fixedItemHeight) {
		...
		/// </summary>
		/// <param name="arrayProperty">Serialized property for entire array.</param>
		public SerializedPropertyAdapter(SerializedProperty arrayProperty) : this(arrayProperty, 0f) {
		}
