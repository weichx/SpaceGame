...
public class SplineQ {
    ...
    private CtrlPoint front {
        get { return mCp[0]; }
    }

    private CtrlPoint back {
        get { return mCp[mCp.Count - 1]; }
    }

    public Quaternion start {
        get { return front.mVal; }
    }

    public Quaternion end {
        get { return back.mVal; }
    }

    public bool isValid {
        get { return mCp.Count > 0; }
    }
